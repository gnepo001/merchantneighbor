...
import os #imports OS for media dir usage
...
SECRET_KEY = config("SECRET_KEY") # enter own secrete key
...
INSTALLED_APPS = [
    ...
    'rest_framework', #API restframe work
    'corsheaders', # cors
    'api',
    'post',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', #needed for media upload
            ],
        },
    },
]
...
#needed to connect frontend to backend
